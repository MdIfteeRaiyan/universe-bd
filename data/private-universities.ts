...
Object.assign(
  universities.find((u) => u.short === "AUB")!,
  {
    ...
    dataContext: {
      ...
      note: "The official calculator exposes a complete total for CSE; other programme totals remain pending until the university publishes readable amounts.",
    },
  },
);
Object.assign(
